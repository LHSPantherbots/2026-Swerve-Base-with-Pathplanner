...
public class IntakePivot extends SubsystemBase {
  ...
  private double intakePivotSetpoint = 0.0;
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber("Intake Pivot Position", intakePivot.getRotorPosition().getValueAsDouble());
    SmartDashboard.putNumber("Intake Pivot Setpoint", intakePivotSetpoint);
    SmartDashboard.putNumber("Intake Pivot Velocity ",intakePivot.getRotorVelocity().getValueAsDouble());
  ...
  public void setIntakeDown(){
    setIntakeSetpoint(0.0);
  }

  public void setIntakeUp(){
    setIntakeSetpoint(70.0);
  }
